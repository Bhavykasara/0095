  ...
  firebase.database().ref("/"+room).on('value',function(snapshot){
    ...
    snapshot.forEach(function(childSnapshot){
      ...
      if (childKey != "purpose") {
          ...
          document.getElementById("chat").innerHTML=document.getElementById("chat").innerHTML+'<h3 id="inf"> Username- '+users+'</h3><h3 id="inf">'+message+'</h3><button class="btn btn-success" id="'+messageID+'" onclick="likes(this.id)" value="'+like+'">Like: '+like+'</button><hr>'
       }
  });
});
}
